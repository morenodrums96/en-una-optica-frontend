  ...
  return (
    <main className="flex-1 p-6 ml-13 bg-primary-50 dark:bg-primary-950 transition-colors duration-300">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={() => setShowModal(true)} className="flex items-center gap-2 bg-primary-400 hover:bg-primary-500 text-white px-4 py-2 rounded-md text-sm transition-colors">
